...
pub(crate) use convert::{
    ...
    entrust_result_to_proto, job_event_to_proto, job_to_proto, kernel_info_to_proto,
    nullifier_path_to_proto, parse_attest_request, parse_coin_proof_request, parse_entrust_request,
    ...
    publish_outcome_to_proto, pull_result_to_proto, record_blob_to_proto, revoke_result_to_proto,
};
